...
SP500ValList = [] # Array of portfolio Value over time
PortfolioValList = [] # Array of SP500 value over time 
...
for index, row in cons.iterrows():
    ...
    if(row[1] == 4 and secondWeek == 2 and B): 
        secondWeek = 0
        ticker_list = []
